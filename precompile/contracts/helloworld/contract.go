...
var (
	...
	ErrInputExceedsLimit = errors.New("input too large cannot call setGreeting")
...
func GetGreeting(stateDB contract.StateDB) string {
	...
	storageKeyHash := common.Hash(
		crypto.Keccak256Hash([]byte(StorageKey)),
	)
